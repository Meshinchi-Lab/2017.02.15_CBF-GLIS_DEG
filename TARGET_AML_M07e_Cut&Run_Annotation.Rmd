...
# write.table(as.data.frame(diff.K), "M0e7_CutnRun_K4me3_CBFGLIS_Minus_glis2Neg_K27ac_K562_CBFGLIS.bed",
#             quote = FALSE,col.names = FALSE, row.names = FALSE, sep="\t")
```

So this result actually makes sense. The GR operation is literally substracting genomic ranges that the two sets have in common. Thus one range that originally say 500pb long, and was a peak for CBFA2T3.M, GLIS2.M, and H3K4me3.M, became two ranges once a peak was detected that was 100bp long in CBFA2T3.K.  
...
Will need to use Bedtools intersect the bed files from the output of DiffBind overlap. 

##stringent

1. bedtools intersect -wa -f 0.5 -r -a ../CBFA2T3.M_IgGremoved.narrowPeak -b ../GLIS2.M_IgGremoved.narrowPeak > MO7e_CBFA2T3_GLIS2_Peaks_0.5overlap.bed

2. bedtools intersect -wa -f 0.5 -a MO7e_CBFA2T3_GLIS2_Peaks_0.5overlap.bed -b ../H3K4me3.M_IgGremoved.broadPeak > MO7e_CBFA2T3_GLIS2_H3K4Me3_Peaks_0.5overlap.bed

DO NOT use -r with the histone mods. Since the TF peak size is so much smaller. 

3. bedtools intersect -v -a MO7e_CBFA2T3_GLIS2_H3K4Me3_Peaks_0.5overlap.bed -b ../K27Ac.M_IgGremoved.broadPeak > MO7e_CBFA2T3_GLIS2_H3K4Me3_Peaks_Removed_K27me3_0.5overlap.bed

4. bedtools intersect -v -a MO7e_CBFA2T3_GLIS2_H3K4Me3_Peaks_Removed_K27me3_0.5overlap.bed -b ../GLIS2.K_IgGremoved.narrowPeak > MO7e_CBFA2T3_GLIS2_H3K4Me3_Peaks_Removed_K27me3_GLIS2.K_0.5overlap.bed
 
5. bedtools intersect -v -a MO7e_CBFA2T3_GLIS2_H3K4Me3_Peaks_Removed_K27me3_GLIS2.K_0.5overlap.bed -b ../CBFA2T3.K_IgGremoved.narrowPeak > MO7e_CBFA2T3_GLIS2_H3K4Me3_Peaks_Removed_K27me3_GLIS2.K_CBFA2T3.K_0.5overlap_New.bed


Number Peaks  | Intersection
----------------------------------------------
   316        | MO7e_CBFA2T3_GLIS2_H3K4Me3_Peaks_0.5overlap.bed
   150        | MO7e_CBFA2T3_GLIS2_H3K4Me3_Peaks_Removed_K27me3_0.5overlap.bed
   149        | MO7e_CBFA2T3_GLIS2_H3K4Me3_Peaks_Removed_K27me3_GLIS2.K_0.5overlap.bed
   107        | *MO7e_CBFA2T3_GLIS2_H3K4Me3_Peaks_Removed_K27me3_GLIS2.K_CBFA2T3.K_0.5overlap.bed*
  1335        | MO7e_CBFA2T3_GLIS2_Peaks_0.5overlap.bed


Not satisfied with the results. There are some peaks that are missing even though visually you can see overlap and those peaks arent called in the negative control. 

The issue above was resolved by removing the -r option (of course!). It meant the broad peaks of H3K4me3 would need to be 


##default

bedtools intersect -wa -a ../CBFA2T3.M_IgGremoved.narrowPeak -b ../GLIS2.M_IgGremoved.narrowPeak > MO7e_CBFA2T3_GLIS2_Peaks_1bpOverlap.bed

bedtools intersect -wa -f 0.5 -a MO7e_CBFA2T3_GLIS2_Peaks_1bpOverlap.bed -b ../H3K4me3.M_IgGremoved.broadPeak > MO7e_CBFA2T3_GLIS2_H3K4Me3_Peaks_1bpOverlap.bed


Number Peaks  | Intersection
----------------------------------------------
   488        | MO7e_CBFA2T3_GLIS2_H3K4Me3_Peaks_1bpOverlap.bed
  1902        | MO7e_CBFA2T3_GLIS2_Peaks_1bpOverlap.bed
...
##peaks
findMotifsGenome.pl MO7e_CBFA2T3_GLIS2_H3K4Me3_Peaks_Removed_K27me3_GLIS2.K_CBFA2T3.K_0.5overlap_New.bed hg19 MO7e_New -size given -preparsedDir tmp 2> M07e_Motifs_New.out &

Definitely interesting results - includes many ETS family TF, ETS-family fusions, and GATA TFs and ERG itself (which has been reported previously so is very promising). 


##DEGs
findMotifs.pl TARGET_AML_CBFGLIS_vs_OtherAML_DnDEGs_Interactions.txt human DnGenes_miR_Ints -start -500 -end 200 -len 8,10 2> DnGenes_miR_Ints.out  &
